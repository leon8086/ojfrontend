...
onMounted(()=>{
  ...
  setInterval( ()=>{
    timeStr.value = utils.duration(moment.now(), examInfo.value.endTime);
  });
});
  ...
  <div id="header">
    <Menu theme="light" mode="horizontal" class="oj-menu">
      ...
      <div class="time-remain">
        ...
        剩余时间：
        <Tag type="dot" :color="timeColor" large><span class="time-str">{{timeStr}}</span></Tag>
              ...
              <Scroll :height="750" style="background-color: white;" class="split-panel">
                <TitledPanel>
                  ...
                  <div class="markdown-body" id="problem-content">
                    ...
                    <p class="content" v-html=item.inputDescription></p>
                    <p class="title">{{ $t('m.Output') }}</p>
                    <p class="content" v-html=item.outputDescription></p>
